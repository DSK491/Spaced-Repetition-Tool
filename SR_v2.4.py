...
1. Creating new tables won't fail with course names containing special characters
...
# creating and initialising table Info (first time)
db.execute('CREATE TABLE IF NOT EXISTS "Info" ("Key" TEXT, "Value" TEXT)')
db.execute('CREATE TABLE IF NOT EXISTS ".Notes" ("Index" INTEGER, "Note" TEXT)')
