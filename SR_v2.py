"""
CHANGELOG:
1. Added submenus to 'Modify Data' submenu.
2. Test Mode is now active. Main Menu and 'View Data' submenu shows if test mode is active on that day.
3. Fixed a few bugs in 'Add Data' submenu:
    a. Semester would always be 1.
    b. 'Course' field would not abort properly.
4. Update_Data now sets status of content overdue for greater than a week to '-3'. 'View Data' will no longer present this content. 
5. Updated Exit screen.
6. Renamed 'Subjects' to 'Courses'.
7. Organized the code into neater blocks for code folding.
